    ...
    <div className="container mx-auto max-w-prose px-4 py-12">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-foreground">
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            Wybierając dostawę do paczkomatu lub punktu odbioru, wskazujesz wygodne miejsce na mapie
            podczas składania zamówienia. Gdy paczka dotrze na miejsce, przewoźnik wyśle Ci SMS lub
            e-mail z informacją o odbiorze. Czas oczekiwania paczki w punkcie określa regulamin
            danego przewoźnika.
          </p>
        </section>
