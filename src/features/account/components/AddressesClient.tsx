      ...
      <div className="flex items-center justify-between">
        ...
        {!editing && (
          <button
            type="button"
            onClick={() => setEditing({})}
            className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors duration-200 hover:bg-primary-deep motion-reduce:transition-none"
          >
            + Dodaj adres
          </button>
        )}
